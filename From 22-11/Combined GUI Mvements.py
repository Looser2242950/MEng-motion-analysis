...
SelectFrameStepUp.pack(expand = 1, fill = BOTH)
TrialFrameMainStepUp= Frame(tab3,bg = "DodgerBlue3")
TrialFrameMainStepUp.pack(expand = 1,fill = BOTH)
...
#Display filenames + whether clean or not    
FrameTrial1StepUp = Frame(TrialFrameStepUp, bg = "ivory3", bd = 6)
FrameTrial1StepUp.pack()
FrameTrial2StepUp = Frame(TrialFrameStepUp, bg = "ghost white", bd = 6)
FrameTrial2StepUp.pack()
FrameTrial3StepUp = Frame(TrialFrameStepUp, bg = "ivory3", bd = 6)
FrameTrial3StepUp.pack()
FrameTrial4StepUp = Frame(TrialFrameStepUp, bg = "ghost white", bd = 6)
FrameTrial4StepUp.pack()
FrameTrial5StepUp = Frame(TrialFrameStepUp, bg = "ivory3", bd = 6)
FrameTrial5StepUp.pack()
FrameTrial6StepUp = Frame(TrialFrameStepUp, bg = "ghost white", bd = 6)
FrameTrial6StepUp.pack()
FrameTrial7StepUp = Frame(TrialFrameStepUp, bg = "ivory3", bd = 6)
FrameTrial7StepUp.pack()
FrameTrial8StepUp = Frame(TrialFrameStepUp, bg = "ghost white", bd = 6)
FrameTrial8StepUp.pack()
FrameTrial9StepUp = Frame(TrialFrameStepUp, bg = "ivory3", bd = 6)
FrameTrial9StepUp.pack()
FrameTrial10StepUp = Frame(TrialFrameStepUp, bg = "ghost white", bd = 6)
FrameTrial10StepUp.pack()
FrameTrial11StepUp = Frame(TrialFrameStepUp, bg = "ivory3", bd = 6)
FrameTrial11StepUp.pack()
FrameTrial12StepUp = Frame(TrialFrameStepUp, bg = "ghost white", bd = 6)
...
label_limb1StepUp = Label(FrameTrial1StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ivory3")
label_limb1StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb2StepUp = Label(FrameTrial2StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ghostwhite")
label_limb2StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb3StepUp = Label(FrameTrial3StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ivory3")
label_limb3StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb4StepUp = Label(FrameTrial4StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ghostwhite")
label_limb4StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb5StepUp = Label(FrameTrial5StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ivory3")
label_limb5StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb6StepUp = Label(FrameTrial6StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ghostwhite")
label_limb6StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb7StepUp = Label(FrameTrial7StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ivory3")
label_limb7StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb8StepUp = Label(FrameTrial8StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ghostwhite")
label_limb8StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb9StepUp = Label(FrameTrial9StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ivory3")
label_limb9StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb10StepUp = Label(FrameTrial10StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ghostwhite")
label_limb10StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb11StepUp = Label(FrameTrial11StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ivory3")
label_limb11StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
label_limb12StepUp = Label(FrameTrial12StepUp,  text = "", width = 10, height = 2 ,  fg = "blue" , bg = "ghostwhite")
label_limb12StepUp.grid(column = 2, row = 1, columnspan = 1, rowspan = 2) 
...
button_exploreStepUp = Button(SelectFrameStepUp, text = "Select up to 12 Trials",  width = 40, bg = "ghost white",
                          command = lambda : [browseFilesStepUp(), extract_all_StepUp_files()])  
button_exploreStepUp.pack(pady=20)
