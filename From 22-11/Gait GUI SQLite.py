...
def extractintoDict(filename, TrialNum):
    ...
    patient["Gait"][TrialNum].update({"Filename":filename})
...
#         #
# def selectall4():
#     c.execute("""SELECT * FROM Gait_Max_Table """)
#     rows = c.fetchall()
#     for row in rows:
#         print(row)

# def selectall5():
#     c.execute("""SELECT max_Ankle_Angle_x_swing, min_Ankle_Angle_x_swing, 
#               max_Ankle_Angle_x_stance, min_Ankle_Angle_x_stance FROM Gait_Max_Table """)
#     rows = c.fetchall()
#     for row in rows:
#         print(row)
# #selectall()  
