...
def select_data_conditional(table, variable, value):
    c.execute("""SELECT * FROM {} WHERE {} == {}""".format(table, variable, value))
    coldata = c.fetchall()
    return coldata
vari1 = "Left_Knee_Angle_x"
variable = "ID"
table = "Mean_Gait_Table"
value = "0001"
data = select_data_conditional(table, variable, value)
print(data)
